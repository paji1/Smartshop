    ...
    <form class="col s12" method="POST" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <input id="icon_prefix" type="email" name="email" class="validate" placeholder="Email" required>
        ...
        <div class="input-field col s6">
          ...
          <input id="icon_prefix" type="text" name="lastname" class="validate"  placeholder="lastname" required >
        ...
        <div class="center-align">
            <input type="submit" id="confirmed" name="signup" class="btn meh button-rounded waves-effect waves-light "></input>
        </div>
